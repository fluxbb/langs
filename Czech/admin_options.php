...
'Enter announcement here'			=>	'Zde zadejte oznámení.',
'Enter rules here'					=>	'Zde zadejte pravidla.',
...
'Options updated redirect'			=>	'Možnosti aktualizovány. Přesměrování…',
'Options head'						=>	'Možnosti',

// Essentials section
'Essentials subhead'				=>	'Základy',
...
'Timezone label'					=>	'Výchozí časová zóna',
'Timezone help'								=>	'The default time zone for guests and users attempting to register for the board.',
'DST label'							=>	'Platí letní čas',
'DST help'							=>	'Zaškrtněte, pokud je v platnosti letní čas (čas posunutý o 1 hodinu).',
'Language label'					=>	'Výchozí jazyk',
...
'Default style label'				=>	'Výchozí styl',
...
'UTC+01:00'							=>	'(UTC+01:00) Střední Evropa (Praha, Bratislava), Západní Afrika',
'UTC+02:00'							=>	'(UTC+02:00) Východní Evropa, Střední Afrika',
'UTC+03:00'							=>	'(UTC+03:00) Moskva, Východní Afrika',
...
// Timeout Section
'Timeouts subhead'					=>	'Čas a časové limity',
'Time format label'					=>	'Formát času',
'PHP manual'						=>	'PHP manuál',
'Time format help'					=>	'[Aktuální formát: %s]. Možnosti formátování viz %s.',
'Date format label'					=>	'Formát data',
'Date format help'					=>	'[Aktuální formát: %s]. Možnosti formátování viz %s.',
...
// Display Section
'Display subhead'					=>	'Zobrazit',
'Version number label'				=>	'Číslo verze',
'Version number help'				=>	'Zobrazit číslo verze FluxBB v zápatí.',
...
'Announcement subhead'				=>	'Oznámení',
'Display announcement label'		=>	'Zobrazit oznámení',
...
// Maintenance Section
'Maintenance subhead'				=>	'Údržba',
'Maintenance mode label'			=>	'Režim údržby',
