...
'Category added redirect'		=>	'カテゴリーが追加されました。リダイレクト中 …',
'Category deleted redirect'		=>	'カテゴリーが削除されました。リダイレクト中 …',
'Delete category head'			=>	'カテゴリーの削除',
'Confirm delete subhead'		=>	'カテゴリーの削除確認',
'Confirm delete info'			=>	'<strong>%s</strong> を削除します。よろしいですか？',
'Delete category warn'			=>	'<strong>警告！</strong> カテゴリーを削除すると、内部のすべてのフォーラムと投稿が削除されます。',
