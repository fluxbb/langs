...
'Invalid webmaster e-mail message'	=>	'ウェブマスターメールアドレスが正しくありません。',
...
'Censor words help'					=>	'掲フォーラム内で特定な語句の入力を抑制できます。詳しくは %s を参照。',
'Signatures label'					=>	'署名',
'Signatures help'					=>	'投稿に署名を添付できます。',
'User ranks label'					=>	'ランク',
'User ranks help'					=>	'ユーザーのランクを表示します。詳しくは %s を参照。',
'User has posted label'				=>	'投稿ユーザー表示（？）',
'User has posted help'				=>	'現在ログインしているユーザーがより早くトピックに投稿した頭の部分をviewforum.phpで表示します。サーバーに負荷が掛かる場合は無効にします。',
...
'Subscriptions label'				=>	'購読',
'Subscriptions help'				=>	'トピックの購読が可能になります。"購読"は誰かが投稿した時にメールで知らせる機能です。',
