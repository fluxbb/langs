...
'Bad HTTP Referer message'			=>	'Falscher HTTP_REFERER. Wenn Sie diese Foren innerhalb Ihrer Verzeichnisstruktur oder auf eine andere Domain verschoben haben, müssen Sie die Basis-URL in der Datenbank manuell aktualisieren (sehen Sie in der Tabelle config nach o_base_url). Leeren Sie dann den Zwischenspeicher, indem Sie alle im Verzeichnis /cache enthaltenen .php-Dateien löschen.',
'Must enter title message'			=>	'Sie müssen einen Titel für dieses Board eingeben.',
'Invalid e-mail message'			=>	'Die für den Administrator eingegebene E-Mail-Adresse ist ungültig.',
'Invalid webmaster e-mail message'	=>	'Die für den Webmaster eingegebene E-Mail-Adresse ist ungültig.',
'SMTP passwords did not match'		=>	'Sie müssen zweimal das exakt gleiche SMTP-Passwort eingeben, um es zu ändern.',
'Enter announcement here'			=>	'Geben Sie hier Ihre Ankündigungen ein.',
'Enter rules here'					=>	'Geben Sie hier Ihre Nutzungsbedingungen ein.',
'Default maintenance message'		=>	'Die Foren sind aufgrund von Wartungsarbeiten vorübergehend geschlossen. Bitte versuchen Sie es in ein paar Minuten noch einmal.',
...
'Base URL help'						=>	'Die vollständige URL des Forums ohne nachfolgenden Schrägstrich (z.B. http://www.meine-domain.de/foren). Damit alle Funktionen für Administratoren und Moderatoren ausgeführt werden können, <strong>MUSS</strong> dieser Eintrag richtig sein. Wenn Sie einen Fehler "Falscher Referrer" bekommen, ist die Basis-URL höchstwahrscheinlich falsch.',
...
'DST help'							=>	'Wählen Sie hier, ob die Sommerzeit verwendet werden soll (der aktuellen Zeit wird 1 Stunde hinzu addiert).',
'Language label'					=>	'Voreingestellte Sprache',
'Language help'						=>	'Das ist die voreingestellte Sprache für Gäste und Mitglieder, die die Voreinstellungen in Ihrem Profil nicht geändert haben. Wenn Sie ein Sprachpaket entfernt haben, muss dieses aktualisiert werden.',
'Default style label'				=>	'Voreingestellter Style',
'Default style help'				=>	'Das ist der voreingestellte Style, der für die Gäste und Mitglieder verwendet wird, die die Voreinstellungen nicht geändert haben.',
...
'UTC+04:00'							=>	'(WEZ+04:00) Golf, Samara',
...
'Time format help'					=>	'[Aktuelles Format: %s]. Weitere Informationen zu den Formatierungs-Optionen finden Sie in der %s.',
'Date format label'					=>	'Datumsformat',
'Date format help'					=>	'[Aktuelles Format: %s]. Weitere Informationen zu den Formatierungs-Optionen finden Sie in der %s.',
...
'Info in posts help'				=>	'Zeigt in der Themenansicht Informationen über den Autor des Beitrags unter dem Mitgliedsnamen an. Die Einstellung hat Auswirkungen auf den Ort, das Registrierungsdatum, den Beitragszähler und die Kontakt-Links (E-Mail und Webseite).',
...
'Censor words help'					=>	'Aktivieren Sie dies, um bestimmte Wörter im Forum zu zensieren. Weitere Informationen dazu finden Sie unter %s.',
...
'Both'								=>	'Beides',
'Reporting method help'				=>	'Wählen Sie hier eine Methode aus, wie Meldungen über Themen/Beiträge behandelt werden sollen. Sie haben mehrere Optionen zur Auswahl - entweder werden die Meldungen über ein internes Berichtssystem verarbeitet oder via E-Mail an eine Mailingliste (siehe unten) versandt. Es können auch beide Optionen parallel verwendet werden.',
...
'Admin e-mail label'				=>	'Administratoren-E-Mail',
'Admin e-mail help'					=>	'Die E-Mail-Adresse des Foren-Administrators.',
'Webmaster e-mail label'			=>	'Webmaster-E-Mail',
'Webmaster e-mail help'				=>	'Das ist die E-Mail-Adresse, die als Absender für alle vom Forum versandten E-Mails verwendet wird.',
'Forum subscriptions label'			=>	'Foren-Abonnements',
'Forum subscriptions help'			=>	'Ermöglicht den Mitgliedern, Foren zu abonnieren (werden bei neuen Themen in diesem Forum via E-Mail informiert).',
'Topic subscriptions label'			=>	'Themen-Abonnements',
'Topic subscriptions help'			=>	'Ermöglicht den Mitgliedern, Themen zu abonnieren (werden bei neuen Beiträgen zu diesem Thema via E-Mail informiert).',
'SMTP address label'				=>	'SMTP-Server-Adresse',
'SMTP address help'					=>	'Die Adresse des externen SMTP-Server, mit dem die E-Mails versandt werden sollen. Sie können hier einen eigenen Port festlegen, falls der SMTP-Server nicht mit dem Standard-Port 25 arbeitet (Beispiel: mail.meinhost.de:3580). Ohne Eintrag wird das lokale Mail-Programm verwendet.',
'SMTP username label'				=>	'SMTP-Benutzername',
'SMTP username help'				=>	'Benutzername für den SMTP-Server. Geben Sie nur dann einen Benutzernamen ein, wenn dieser vom SMTP-Server angefordert wird (bei den meisten Servern ist <strong>keine</strong> Authentifizierung erforderlich).',
'SMTP password label'				=>	'SMTP-Passwort',
'SMTP change password help'			=>	'Aktivieren Sie dies, um das aktuell gespeicherte Passwort zu ändern oder zu löschen.',
'SMTP password help'				=>	'Passwort für den SMTP-Server. Geben Sie nur dann ein Passwort ein, wenn dieses vom SMTP-Server angefordert wird (bei den meisten Servern ist <strong>keine</strong> Authentifizierung erforderlich).',
'SMTP SSL label'					=>	'SMTP mit SSL verschlüsseln',
'SMTP SSL help'						=>	'Verschlüsselt die Verbindung mit dem SMTP-Server mit SSL. Sollte nur dann verwendet werden, wenn Ihr SMTP-Server es erfordert und Ihre PHP-Version SSL unterstützt.',
...
'Verify help'						=>	'Wird dies aktiviert, wird den Neu-Mitgliedern nach der Registrierung ein zufällig erstelltes Password via E-Mail zugesandt. Erst dann können sich die neuen Mitglieder anmelden und das Passwort in ihrem Profil ändern. Auch wenn die ursprünglichen Registrierungs-E-Mail-Adresse in eine andere geändert wird, ist eine Bestätigung durch das Mitglied notwendig. Dies ist ein effektiver Weg, um mißbräuchliche Registrierungen zu vermeiden und sicherzustellen, dass in den Profilen der Mitglieder die "richtigen" E-Mail-Adressen eingetragen sind.',
...
'Rules help'						=>	'Hier können Sie die Nutzungsbedingungen und sonstige Informationen eingeben, die sich jedes neue Mitglied durchlesen und akzeptieren muss. Um diese Option zu aktivieren, geben Sie in dieses Feld Ihre Nutzungsbedingungen ein. Ohne Eintrag bleibt diese Option deaktiviert. Dieser Text wird nicht wie reguläre Beiträge verarbeitet und kann daher HTML enthalten.',
'E-mail default label'				=>	'Standard-E-Mail-Einstellungen',
'E-mail default help'				=>	'Wählen Sie die die Privatsphären-Einstellungen für neu registrierte Mitglieder.',
'Display e-mail label'				=>	'Anderen Mitgliedern die E-Mail-Adresse anzeigen.',
'Hide allow form label'				=>	'Die E-Mail-Adresse verbergen aber die Kontaktaufnahme via Formular erlauben.',
'Hide both label'					=>	'Die E-Mail-Adresse verbergen und die Kontaktaufnahme via Formular verbieten.',

// Sektion Ankündigungen
'Announcement subhead'				=>	'Ankündigungen',
'Display announcement label'		=>	'Ankündigungen anzeigen',
'Display announcement help'			=>	'Aktivieren Sie diese Option, um die unten angezeigte Nachricht oberhalb der Foren anzuzeigen.',
'Announcement message label'		=>	'Text der Ankündigung',
'Announcement message help'			=>	'Dieser Text wird nicht wie ein regulärer Beitrag verarbeitet und kann daher HTML enthalten.',

// Sektion Wartung
'Maintenance subhead'				=>	'Wartung',
'Maintenance mode label'			=>	'Wartungs-Modus',
'Maintenance mode help'				=>	'Wird diese Option aktiviert, können nur die Administratoren auf das Board zugreifen. Dieser Modus sollte verwendet werden, wenn zeitlich beschränkte Wartungsarbeiten am Board notwendig sind. WARNUNG! Melden Sie sich NIEMALS ab, wenn sich das Board im Wartungs-Modus befindet. Sie können sich sonst anschließend niemals wieder anmelden.',
'Maintenance message label'			=>	'Wartungs-Nachricht',
'Maintenance message help'			=>	'Die Nachricht, die den Besuchern der Webseite angezeigt wird, wenn sich das Board im Wartungs-Modus befindet. Bleibt dieses Feld leer, wird eine voreingestellte Nachricht verwendet. Dieser Text wird nicht wie ein regulärer Beitrag verarbeitet und kann daher HTML enthalten.',
