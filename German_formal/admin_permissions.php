...
'Require e-mail label'		=>	'Gast-E-Mail notwendig',
'Require e-mail help'		=>	'Verlangt von Gästen die Angabe einer E-Mail-Adresse, wenn diese einen Beitrag erstellen wollen.',
...
'Banned e-mail label'		=>	'Gesperrte E-Mail-Adressen erlauben',
'Banned e-mail help'		=>	'Erlaubt Mitgliedern, sich mit einer gesperrten E-Mail-Adresse/Domain zu registrieren oder die E-Mail-Adresse auf einen solchen Wert zu ändern. Bleiben die Voreinstellungen unverändert (ja), wird diese Aktion erlaubt aber es wird eine Warn-Nachricht an die Mailingliste versandt (ein effektiver Weg, um Mehrfachregistrierungen zu erkennen).',
'Duplicate e-mail label'	=>	'Doppelte E-Mail-Adressen erlauben',
'Duplicate e-mail help'		=>	'Legt fest, ob sich ein neues Mitglied mit einer E-Mail-Adresse registrieren darf, die bereits von einem anderen Mitglied verwendet wird. Ist dies erlaubt, wird eine Warn-Nachricht an die Mailingliste versandt, sobald die Dopplung festgestellt wird.',
