...
// Navigation and sections
    ...
    'Section personality'         => 'Индивидуализация',
...
// Avatar upload stuff
    'Avatars disabled'            => 'Админ отключил использование аватаров.',
    ...
    'pixels'                      => 'пикс.',
    'bytes'                       => 'байт',
    'Move failed'                 => 'Сервер не смог переместить загруженный файл. Пожалуйста, свяжитесь с Админом по адресу',
...
// Profile display stuff
    ...
    'Signature legend'            => 'Сочините вашу подпись',
    'Signature info'              => 'Подпись — небольшой текст, присоединяемый к вашему сообщению. Здесь вы можете указать что угодно. Возможно, вы захотите поместить сюда любимую цитату или скан вашей росписи. В подпись можно включать форматирование BBCode, если это не запрещено настройками форума. Вы можете увидеть, какие именно возможности включены, в примечании под полем ввода подписи.',
