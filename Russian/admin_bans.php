...
'E-mail label'				=>	'Email',
'E-mail help'				=>	'Email или целый домен, который вы ,eltnt забанить (т.е. someone@somewhere.com или somewhere.com). См. опцию "Разрешить забаненные email" в разделе Права.',
...
'Ban IP range info'			=>	'Будте предельно осторожны с IP-диапазонами, потому что под это правило могут попасть несколько пользователей.',
