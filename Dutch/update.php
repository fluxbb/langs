...
'Note'							=>	'Nota:',
'Members message'				=>	'Dit proces is enkel voor admins. Als je een member bent is er niks waar je je zorgen over moet maken - het forum is later terug!',
...
'Enable conversion'				=>	'<strong>Conversie inschakelen:</strong> Als het update script klaar is met de aanpassingen aan de database zal hij de huidige tekenset converteren naar UTF-8. Deze conversie is nodig als je wilt upgraden van versie 0.x.',
'Current character set'			=>	'<strong>Huidige tekensett:</strong> Als de huidige standaardtaal van je forum Engels is, kan je dit veld leeg laten. Voor andere talen moet je de tekenset van het gebruikte taal pak infullen in dit veld. <em>Als dit fout is kan je database beschadigd raken, gok niet!</em> Nota: Dit is nodig, ook als je oude database werkt met UTF-8',
...
'Current character set info'	=>	'Standaard voor Engels, anders gebruikt je de tekenset van het huidige standaard taalpakket.',
'Start update'					=>	'Start update',
'Error converting users'		=>	'Fout bij gebruikers converteren',
'Error info 1'					=>	'Er is een fout opgedreden bij het converteren van een of meerdere members. Dit kan voorkomen bij convertering van 384bb 0.x als meerdere gebruikers hebben geregistreerd met een vergelijkbare gebruikersnaam, zoals "anne" en "anné".',
'Error info 2'					=>	'Onderstaande gebruikers konden niet worden geconverteerd. Kies een nieuwe gebruikersnaam voor ze. Gebruikers die in dit proces worden hernoemd krijgen automatisch een mail die de aanpassing aan de desbetreffende members meld.',
'New username'					=>	'Nieuwe gebruikersnaam',
'Required'						=>	'(Verplicht)',
'Correct errors'				=>	'De volgende problemen moeten worden opgelost:',
'Rename users'					=>	'Hernoem members',
