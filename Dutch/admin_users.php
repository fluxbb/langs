...
'No move admins message'	=>	'Omwillen van veiligheid kan je niet meerdere admins naar een andere groep verplaatsen. For security reasons, you are not allowed to move multiple administrators to another group. Als je deze admins wilt verplaatsen kan dat via hun gebruikersprofiel.',
...
'Users delete redirect'		=>	'Members verbannen. Doorverwijzen …',
'Ban users'					=>	'Verban members',
'Message expiry subhead'	=>	'Ban bericht en vervaldatum',
'Ban message label'			=>	'Ban bericht',
'Ban message help'			=>	'Het bericht dat wordt getoond aan een verbannen member indien deze het forum bezoekt.',
...
'Ban IP help'				=>	'Verban ook het IP adres van een verbannen member om het registeren moeilijker te maken voor deze member (maar niet onmogelijk).',
...
'Users banned redirect'		=>	'Member verbannen. Doorverwijzen …',

'User search head'			=>	'Gebruiker zoeken',
'User search subhead'		=>	'Geef zoekopdracht in',
'User search info'			=>	'Zoek naar members in de database. Je kan meerdere velden invullen om te zoeken. Jokertekens en sterretjes (*) zijn toegestaan.',
'Username label'			=>	'Gebruikersnaam',
'E-mail address label'		=>	'Mail adres',
'Title label'				=>	'Rang',
