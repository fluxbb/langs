...
'Rebuild completed info'		=>	'Als dit proces klaar is wordt je automatisch terug gestuurd naar deze pagina. Het wordt aangeraden om JavaScript aan te zetten voor je browser tijdens dit proces (zo kan de pagina worden herladen als een cycle klaar is). Als het proces wordt onderbroken, onthoud dan het ID van de post die als laatst werd gebruikt. Later kan je dan dit ID+1 invoeren in het veld "Start post ID" om verder te gaan (Let wel op dat "Verwijder index" uit staat!).',
...
'Posts must be integer message'	=>	'Posts per cycle moet een positief getal zijn.',
'Days must be integer message'	=>	'Aantal dagen oud moet een positief getal zijn.',
...
'Prune info'					=>	'Gebruik de mogelijkheid met volle verstand. <strong>Opgeruimde posts kunnen niet worden hersteld.</strong> Voor de beste prestaties kan je het forum in %s zetten tijdens het proces.',
