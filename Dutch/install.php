...
'InnoDB'						=>	'Jouw MySQL server bied ondersteuning voor <a href="http://dev.mysql.com/doc/refman/5.0/en/innodb.html">InnoDB</a>. Dit is een goede keuze indien je een groot forum wil gaan beheren. Als je onzeker bent, is het raadzaam niet te kiezen voor InnoDB.',
...
'Info 4'						=>	'Dit is de naam van de database waar FluxBB op zal worden geïnstalleerd. De database moet al bestaan. Voor SQLite geef je hier het pad naar het database bestand op. Wegens beveiligingsvoorzorgen is het aangeraden de SQLite database ergens te plaatsen waar niemand er bij kan. Als het SQLite database bestand niet bestaat, zal FluxBB proberen dit automatisch aan te maken.',
...
'Info 8'						=>	'De gebruikersnaam van de forum admin. Je kan later meer administrators en moderators. Gebruikersnamen mogen 2 tot 25 tekens bevatten.',
...
'Info 13'						=>	'Een korte beschrijving/ondertitel van het forum (zichtbaar op iedere pagina). Dit veld ondersteund HTML.',
'Board description'				=>	'Forum beschrijving/ondertitel',
'Enter base URL'				=>	'Geef het hoofddomein van je FluxBB installatie',
'Info 14'						=>	'De URL (zonder slash) van je FluxBB forum (voorbeeld: http://forum.mijnhost.be of http://mijnhost.be/~myuser). Dit <strong>moet</strong> correct zijn, anders kunnen Admins en Moderators geen forums beheren. Let erop dat het opgegeven voorbeeld slechts ter illustratie is gekozen door FluxBB en voor jou niet klopt.',
