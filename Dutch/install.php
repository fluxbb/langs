...
'Choose install language info'	=>	'Dit past alleen de taal van de installatie procedure aan, die van het forum zelf kan later worden geweizigd.',
...
'Description'					=>	'it\'s just our forum.',
...
'Wrong email'					=>	'Het admin ail adres dat je hebt opgegeven komt niet overeen.',
'No board title'				=>	'Je moet een titel opgeven.',
'Error default language'		=>	'De gekozen taal lijkt niet te bestaan.',
'Error default style'			=>	'Het gekozen design lijkt niet te bestaan.',
...
'Info 5'						=>	'Geef de gebruikersnaam en het wachtwoord op waarmee verbinding kan worden gemaakt met de opgegeven database. Negeren dit indien u SQLite gebruikt.',
...
'Info 15'						=>	'De standaard taal die het forum zal aannemen voor gebruikers en gasten die de taal van het forum niet hebben gewijzigd in hun profiel.',
'Default language'				=>	'Standaard taal',
'Choose the default style'		=>	'Kies een standaard design',
'Info 16'						=>	'Het design (uiterlijk) dat het forum zal aannemen voor gebruikers en gasten die het design van het forum niet hebben gewijzigd in het profiel.',
'Default style'					=>	'Standaard design',
...
'Test post'						=>	'Test post',
'Message'						=>	'Als je hier naar kijkt (en ik denk dat je dat nu wel doet) is de installatie voor 100% voltooid en kan je aan de slog! Log in en ga naar het adminpaneel om je forum te configureren',
'Test category'					=>	'Test categorie',
'Test forum'					=>	'Test forum',
'This is just a test forum'		=>	'Dit is een test forum',
'Alert cache'					=>	'<strong>De cache map kan niet worden beschreven!</strong> Om FluxBB te latne werken moet de map <em>%s</em> beschrijfbaar zijn. Gebruik chmod om de permissies te wijzigen. Bij twijfel, chmod naar 0777.',
