...
'Default group redirect'		=>	'Standard gruppe sat. Omdirrgerer …',
...
'Group removed redirect'		=>	'Gruppe slettet. Omdirigerer …',
'Group added redirect'			=>	'Gruppe tilføjet. Omdirigerer …',
'Group edited redirect'			=>	'Gruppe redigeret. Omdirigerer …',
...
'Default group help'			=>	'Dette er standard brugergruppen, f.eks. Den gruppe nye brugere bliver placeret i når de registrerer. For sikkerhedsgrunde, kan brugere ikke blive placeret i enten moderator eller administrator gruppen som standard.',
'Existing groups head'			=>	'Eksisterende grupper',
'Edit groups subhead'			=>	'Rediger/slet grupper',
'Edit groups info'				=>	'De foruddefinerede grupper Gæst, Administratorer, Moderatorer og Medlemmer kan ikke slettes. De kan dog redigeres. Venligst bemærk at der i nogen grupper er muligheder som ikke er tilgænglige (f.eks. <em>rediger postering</em> rettigheden for gæster). Administratorer har altid globale rettigheder.',
'Edit link'						=>	'Rediger',
'Delete link'					=>	'Slet',
