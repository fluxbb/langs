...
'Options updated redirect'			=>	'تنظیمات به روز شد. در حال انتقال …',
'Options head'						=>	'گزینه ها',

// Essentials section
'Essentials subhead'				=>	'Essentials',
'Board title label'					=>	'عنوان انجمن',
'Board title help'					=>	'عنوان این انجمن گفتگو (جهت نمایش در بالای تمامی صفحات). این کادر <strong>نباید</strong> حاوی HTML باشد.',
'Board desc label'					=>	'وصف انجمن',
'Board desc help'					=>	'شرح کوتاهی از این انجمن گفتگو (جهت نمایش در بالای تمامی صفحات). این کادر می تواند حاوی HTML باشد.',
'Base URL label'					=>	'URL مبنا',
...
// Timeout Section
'Timeouts subhead'					=>	'زمان و مهلت های زمانی',
...
'Version number help'				=>	'شماره نسخه FluxBB را در پایین صفحات نشان بده.',
'Info in posts label'				=>	'اطلاعات کاربر در مطالب',
...
'Post count label'					=>	'تعداد مطالب کاربر',
'Post count help'					=>	'Show the number of posts a user has made (affects topic view, profile and user list).',
'Smilies label'						=>	'خندانک ها در مطالب',
'Smilies help'						=>	'خندانک ها را به آیکون های کوچکی تبدیل کن.',
'Smilies sigs label'				=>	'خندانک ها در امضاها',
...
'Users online label'				=>	'کاربران برخط',
...
'Search all label'					=>	'جستجو در تمامی تالارها',
...
'Menu items label'					=>	'آیتم های منوی اضافی',
...
'Reporting method label'			=>	'روش گزارش کردن',
'Internal'							=>	'داخلی',
'By e-mail'							=>	'ایمیل',
'Both'								=>	'هردو',
...
'SMTP password label'				=>	'رمز عبور SMTP',
