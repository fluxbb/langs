...
'Posts must be integer message'	=>	'Mensajes por ciclo debe ser un valor entero positivo.',
'Days must be integer message'	=>	'Días para purgar debe ser un valor entero positivo.',
'No old topics message'			=>	'No hay temas de %s dias atras. Por favor disminuye el valor de "Días atras" y vuelva a intentarlo.',
'Posts pruned redirect'			=>	'Mensajes purgados. Redireccionando …',
'Prune head'					=>	'Purgar',
'Prune subhead'					=>	'Purgar mensajes antiguos',
'Days old label'				=>	'Días atras',
'Days old help'					=>	'El número de días "atras" de un tema debe ser para ser purgado. Ej. si usted fuera a entrar 30, todos los temas que no contienen un mensaje de fecha menos de 30 días se eliminarán.',
'Prune sticky label'			=>	'Purgar temas pegados',
'Prune sticky help'				=>	'Cuando está activado, los temas pegados también se purgan.',
'Prune from label'				=>	'Purgar el foro',
'All forums'					=>	'Todos los foros',
'Prune from help'				=>	'El foro desde el que desea purgar los mensajes.',
'Prune info'					=>	'Utilice esta función con precaución. <strong>Mensajes purgados no se puede recuperar.</strong> Para un mejor desempeño, usted debe poner el foro en %s durante la purga.',
'Confirm prune subhead'			=>	'Confirme los mensajes a purgar',
'Confirm prune info'			=>	'Está seguro que desea purgar todos los temas mayores de %s días desde %s (%s temas).',
'Confirm prune warn'			=>	'ADVERTENCIA! Mensajes a purgar se eliminan permanentemente.',
