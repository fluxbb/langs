...
'Must enter message'		=>	'Você deve fornecer um nome de usuário, endereço IP ou endereço de e-mail (ao menos).',
...
'Invalid e-mail message'	=>	'O endereço de e-mail (ex. usuário@domínio.com.br) ou domínio de endereço de e-mail (ex. domínio.com.br) fornecido é inválido.',
...
'Username advanced help'	=>	'O nome de usuário a ser banido (insensível à caixa). A próxima página lhe permitirá definir um IP e e-mail personalizados. Se você deseja banir um e-mail ou endereço/faixa de endereços IP específicos apenas deixe em branco.',
...
'E-mail label'				=>	'Email',
'E-mail help'				=>	'O email ou domínio de email que você deseja banir (ex. alguém@algumlugar.com.br ou algumlugar.com.br). Veja "Permitir endereços de email banidos" em Permissões para obter mais informações.',
