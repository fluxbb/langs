...
'Newest user'	=>	'Mais novo usuário registrado: %s',
'Users online'	=>	'Usuários registrados online: %s',
'Guests online'	=>	'Visitantes online: %s',
'No of users'	=>	'Número total de usuários registrados: %s',
'No of topics'	=>	'Número total de tópicos: %s',
'No of posts'	=>	'Número total de mensagens: %s',
