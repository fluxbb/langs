...
'Info 4'						=>	'اسم قاعدة البيانات التي سيقوم FluxBB بالتركيب عليها بياناته. قاعدة البيانات يجب أن تكون موجودة، للـ SQLite ممكن أن يكون عبارة عن مسار مرجعي لملف. لأسباب أمنية، يفضل أن تضع ملف SQLite قاعدة البيانات في مسار خاص لا يمكن الوصول إليه بسهولة من الموقع بشكل مباشر. إذا كان ملف قاعدة البيانات لـ SQLite غير موجود فسيتم إنشاءه تلقائياً.',
...
'Maintenance message'			=>	'المنتديات حاليا في وضع الصيانة مؤقتاً. رجاءاً حاول مرة أخرى بعد عدة دقائق.',
...
'Alert cache'					=>	'<strong>فهرس (مجلد) التخزين المؤقت cache غير قابل للكتابة</strong> لكي يعمل FluxBB بشكل جيد، أنت بحاجة لجعل <em>%s</em> قابل للكتابة من قبل الـ PHP. استخدم chmod لتعديل الصلاحيات على هذا الفهرس، يمكن أن يكون 0777 هي قيمة هذه الصلاحيات.',
'Alert avatar'					=>	'<strong>فهرس (مجلد) الصور avatars غير قابل للكتابة</strong>، إذا اردت أن تسمح لمستخدميك بتحميل صورة خاصة بهم أنت بحاجة لجعل الفهرس <em>%s</em> قابل للكتابة من قبل الـ PHP. يمكنك تحديد مسار آخر للفهرس ضمن خيارات الإدارة. استخدم chmod لتعديل الصلاحيات على هذا الفهرس، يمكن أن يكون 0777 هي قيمة هذه الصلاحيات.',
