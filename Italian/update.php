...
'Database password info' 		=> 'Per effettuare l\'aggiornamento inserire la password del database nel quale FluxBB &egrave; installato. In caso di incertezza &egrave; possibile ritrovarla modificando il file \'config.php\'.',
...
'Invalid password error' 		=> 'Password del database errata. Per aggiornare FluxBB la password deve essere inserita esattamente come riportata in \'%s\'',
...
'Intro 1'						=> 'Questo script aggiorner&agrave; il database del forum. L\'elaborazione pu&ograve; durare pochi secondi cos&igrave; come alcune ore: dipende della dimensione dell\'archivio e della velocit&agave; del server. Effettuare un copia di sicurezza dell\'attuale database prima di continuare.',
...
'Current character set info' 	=> 'Impostare il valore predefinito per forum in inglese o il set di caratteri relativi alla lingua desiderata.',
