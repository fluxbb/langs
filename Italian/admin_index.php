...
'Server statistics label'           =>  'Statistiche server',
'View server statistics'            =>  'Visualizzare le statistiche server',
'Support label'                     =>  'Supporto',
'Forum label'                       =>  'Forum',
'IRC label'                         =>  'Canale IRC',

// Definizioni di lingua usate in admin_statistics.php
'PHPinfo disabled message'          =>  'La funzione PHP \"phpinfo()\" &egrave; disabilitata su questo server.',
'Server statistics head'            =>  'Statistiche server',
