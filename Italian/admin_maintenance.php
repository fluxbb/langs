...
'Javascript redirect failed'	=>	'Aggiornamento pagina via JavaScript non riuscito. %s per continuare &hellip;',
'Posts must be integer message' =>  'Il numero di discussioni per ogni aggiornamento deve essere un numero positivo intero.',
...
'Prune subhead'				    =>	'Effettua la pulizia (<em>prune</em>) dai vecchi messaggi',
'Days old label'			    =>	'Giorni di anzianit&agrave;',
'Days old help'				    =>	'I giorni minimi di anzianit&agrave; che una discussione deve avere per essere soggetta alla pulizia. Esempio: inserendo 30, ogni discussione pi&ugrave; vecchia di trenta giorni che non contiene alcuna risposta sar&agrave; <strong>cancellata definitivamente</strong>.',
...
'Confirm prune info'		    =>	'Sei sicuro di voler cancellare (<em>prune</em>) le discussioni senza messaggi vecchie di %s giorni da %s (%s discussioni)?',
