...
'Install message'			 	=> 'Il file \'config.php\' sembra non esistere (o &egrave; corrotto). FluxBB non &egrave; perci&ograve; stato ancora installato. Per istallarlo, seguire le istruzioni seguenti.',
...
'Description' 					=> 'Nessuno pu&oacute; descrivere cosa sia FluxBB, bisogna provarlo!',
...
'Info 2' 						=> 'FluxBB attualmente supporta MySQL, PostgreSQL e SQLite. Qualora il database scelto non fosse presente nel menu a cascata, l\'ambiente di PHP installato non dispone del supporto necessario. Ulteriori informazioni sul supporto di versioni particolari sono reperibili nelle FAQ online.',
...
'Info 14' 						=> 'L\'indirizzo del forum del forum (esempio: http://forum.miosito.est o http://miosito.est/forum). Assicurarsi della correttezza di questo campo e non tralasciare le slash. In caso di errore gli amministratori e i moderatori non saranno in grado di pubblicare alcun messaggio. Il valore predefinito &egrave; semplicemente FluxBB.',
...
'Alert avatar' 					=> '<strong>La cartella <em>avatar</em> non &egrave; scrivibile!</strong> Affinch&eacute; gli utenti possano caricare delle proprie immagini personali, &egrave; necessario che la cartella <em>img/avatars</em> disponga dei permessi di scrittura per PHP. Successivamente &egrave; possibile decidere una cartella differente (si veda: Amministrazione/Opzioni). Usare il comando <em>chmod</em> per impostare i permessi appropriati. In caso di dubbio, impostare 0777',
...
'FluxBB has been installed' 	=> 'FluxBB &egrave stato installato! <strong>Per completare l\'installazione</strong> seguire le successive istruzioni.',
'Final instructions' 			=> 'Istruzioni finali',
'Info 17' 						=> 'Per completare l\'installazione, &egrave necessario scaricare dal collegamento a fondo pagina il file <em>config.php</em>. Questo file <strong>deve</strong> essere caricato nella cartella di radice dell\'installazione di FluxBB.',
