...
'Base URL problem'                  =>  'Questa installazione non supporta la conversione automatica dei domini internazionalizzati. Poich&eacute; il tuo indirizzo base contiene caratteri speciali, <strong>&egrave; necessario</strong> usare un convertitore online per evitare errori di "Bad referer".',
...
'Info in posts help'				=>	'Mostrare le informazioni dell\'autore sotto il nome utente nelle discussioni. Le informazioni mostrate sono: luogo, data di registrazione, numero di messaggi e dati di contatto (email e URL).',
...
'Signatures help'					=>	'Permette agli utenti di allegare una firma ai propri messaggi.',
...
'SMTP password help'				=>	'Inserire due volte la password per il server SMTP. Specificare un nome utente solo se richiesto dal server SMTP (la maggioranza <strong>non richiesde</strong> autenticazione).',
...
'Report new help'					=>	'Abilita la notifica agli utenti presenti nella mailing list (si veda l\'elenco precedente) quando un nuovo utente si registra.',
...
'Maintenance message help'			=>	'Questo messaggio sar&agrave; visualizzato dagli utenti quando &egrave; attivo il modo manutenzione. Se lasciato vuoto, sar&agrave; utilizzato un messaggio predefinito. Il testo pu&ograve; contenere HTML.',
