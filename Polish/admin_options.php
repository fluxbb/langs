...
'SMTP passwords did not match'		=>	'Musisz podać dwa razy hasło do serwera SMTP.',
...
'RSS'								=>	'RSS',
'Atom'								=>	'Atom',
'Feed TTL label'					=>	'Długość przechowywania kanałów',
'Feed TTL help'						=>	'Kanały mogą być przechowywane w pamięci podręcznej w celu zmniejszenia zużycia zasobów.',
'No cache'							=>	'Nie twórz pamięci podręcznej',
'Minutes'							=>	'%d minut',
...
'Forum subscriptions label'			=>	'Subskrybcje forum',
'Forum subscriptions help'			=>	'Pozwól użytkownikom subskrybować fora (będą otrzymywać powiadomienie email kiedy ktoś założy nowy wątek).',
'Topic subscriptions label'			=>	'Subskrybcje wątków',
'Topic subscriptions help'			=>	'Pozwól użytkownikom subskrybować wątki (będą otrzymywać powiadomienie email kiedy ktoś napisze odpowiedź).',
...
'SMTP change password help'			=>	'Zaznacz to pole, jeśli chcesz zmienić lub usunąć aktualnie zapisane hasło.',
