...
'Bad referrer'						=>	'HTTP_REFERER اشتباه . شما از یک منبع غیرمجاز به این صفحه مراجعه کرده اید . اگر این مشکل ادامه داشت لطفا ً مطمئن شوید که \'Base URL\' بدرستی در مدیریت / گزینه ها تنظیم شده و شما با مراجعه به آن آدرس دارید از انجمن بازدید میکنید . اطلاعات بیشتر درمورد بررسی ارجاع را میتوانید در مستندات FluxBB بیابید.',
'Bad csrf hash'						=>	'CSRF hash اشتباه . شما از یک منبع غیر مجاز به این صفحه مراجعه کرده اید.',
'No cookie'							=>	'بنظر می آید با موفقیت وارد انجمن شده اید ، به هرحال کوکی تنظیم نشده است . لطفا ً تنظیمات خود را بررسی کرده و اگر مقدور است ، کوکی ها را برای این سایت فعال کنید.',
...
'Ban message 3'						=>	'مدیرکل یا مدیر انجمنی که شما را مسدود کرده پیام ذیل را برای شما گذاشته است:',
'Ban message 4'						=>	'لطفا ً هرگونه سوال را مستقیما ً از مدیراصلی انجمن بپرسید :',
'Never'								=>	'هرگز',
'Today'								=>	'امروز',
'Yesterday'							=>	'دیروز',
...
'BBCode list size error'			=>	'لیست شما برای تجزیه و تحلیل بسیار بلند است ، لطفا ً آن را کوچک تر کنید!',

// Stuff for the navigator (top of every page)
'Index'								=>	'فهرست',
'User list'							=>	'لیست كاربران',
'Rules'								=>	'قوانین',
'Search'							=>	'جستجو',
'Register'							=>	'ثبت نام',
'Login'								=>	'ورود',
