...
'Update message'				=>	'پایگاه داده FluxBB شما منسوخ شده و برای ادامه باید ارتقاء داده شود . اگر شما مدیر تالارگفتگو هستید ، لطفا ً دستورالعملهای ذیل را برای تکمیل و ارتقاء دنبال کنید.',
'Note'							=>	'توجه:',
...
'Database password info'		=>	'برای اجرای بروزرسانی پایگاه داده لطفا ً پسورد پایگاه داده ای که FluxBB در آن نصب شده است را وارد کنید . اگر پسورد را بخاطر نمی آورید ، در فایل \'config.php\' ذخیره شده است.',
'Database password note'		=>	'اگر شما SQLite را اجرا میکنید ( بنابراین پایگاه داده پسوردی ندارد ) لطفا ً درعوض از نام پایگاه داده استفاده کنید . این باید دقیقا ً با نام پایگاه داده ای که در فایل پیکربندی داده اید مطابقت کند.',
'Database password'				=>	'پسورد پایگاه داده',
'Maintenance'					=>	'تعمیر و نگهداری',
'Maintenance message info'		=>	'پيامي كه به كاربراني كه هنگام انجمن در حین عملیات پردازش بروزرسانی ميباشد به نمايش درخواهد آمد . اگر خالي بگذاريد ، يك پيام پيش فرض به نمايش داده ميشود . اين متن مثل ارسال هاي معمولي تحليل نميشوند بنابراين ميتواند شامل HTML باشد.',
...
'Invalid password error'		=>	'پسورد پایگاه داده معتبر نمیباشد . برای بروزرسانی FluxBB شما باید پسورد پایگاه داده خود دقیقا ً شبیه چیزی که در \'%s\' نوشتید را وارد کنید',
'No password error'				=>	'هیچ پسورد پایگاه داده ای ارائه نکردید',
'Script runs error'				=>	'بنظر میرسد اسکریپت بروزرسانی هم اکنون توسط شخص دیگری درحال اجراست . اگر این چنین نیست ، لطفا ً بصورت دستی فایل \'%s\' را حذف کرده و دوباره تلاش کنید',
...
'Error info 2'					=>	'در پایین لیستی از کاربرانی که در تبدیل با شکست روبرو شد ، میباشد . لطفا ً برای هرکدام از کاربران یک نام کاربر جدید انتخاب کنید . کاربرانی که تغییر نام داده میشوند بصورت خودکار جهت اطلاع رسانی از تغییرات ایمیلی برایشان ارسال میشود.',
...
'Unable to lock error'			=>	'سیستم قادر به نوشتن قفل بروزرسانی نمیباشد . لطفا ً مطمئن شوید که PHP دسترسی نوشتن به پوشه \'%s\' را دارد و همچنین شخص دیگری درحال اجرای اسکریپت بروزرسانی نمیباشد.',
