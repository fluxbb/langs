...
'No user message'			=>	'هیچ کاربری با این نام کاربری ثبت نام نکرده است . اگر شما میخواهید یک ممنوعیت را بدون رابطه با یک نام کاربری خاصی اضافه کنید ، نام کاربری را خالی بگذارید.',
...
'Ban advanced head'			=>	'تنظیمات پیشرفته مسدودیت',
'Ban advanced subhead'		=>	'الحاق مسدودیت توسط IP و ایمیل',
'Ban message label'			=>	'پیام مسدودیت',
'Ban message help'			=>	'یک پیام برای نمایش به کاربر مسدود شده هنگامی که از تالار گفتگو دیدن میکند.',
'Message expiry subhead'	=>	'پیام مسدودیت و انقضای آن',
