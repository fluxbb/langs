...
'Rebuild completed info'		=>	'一旦該過程結束，您將被重新導向回此頁面。強烈建議您在操作過程中開啟瀏覽器的JavaScript功能(以使一個週期完成後能夠自動重新導向)。如果重建過程被迫中止，您也可以記下已處理的最後一篇文章的ID然後將「起始文章的ID」輸入為該ID+1再繼續建立索引(此時不得勾選「清空索引」選項)。',
'Rebuild index'					=>	'重建索引',
