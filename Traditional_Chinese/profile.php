...
'Personal details legend'		=>	'輸入您的身份訊息',
'Contact details legend'		=>	'輸入您的即時通訊息',
'User activity'					=>	'會員活動',
'Paginate info'					=>	'輸入數字以設定每頁顯示的主題和文章的數目。',

// Password stuff
'Pass key bad'					=>	'該密碼啟用不正確或已過期。請重新申請一個密碼。如操作失敗請聯繫論壇管理員',
...
// Email stuff
'Email key bad'					=>	'該電子信箱啟用密鑰不正確或已過期。請重新更改電子信箱。如操作失敗請聯繫論壇管理員',
'Email updated'					=>	'您的電子信箱已更新。',
'Activate email sent'			=>	'已發送郵件至您指定的電子信箱，說明如何啟用新的電子信箱。如未收到請聯繫論壇管理員',
'Email legend'					=>	'輸入您的新電子信箱',
'Email instructions'			=>	'一封包含啟用連結的郵件將會發送至您的新電子信箱。您必須點選該郵件中的連結才能啟用您的新電子信箱。',
'Change email'					=>	'更改電子信箱',
'New email'						=>	'新電子信箱',
...
'Moderator in info'				=>	'選擇相應的論壇版面以允許這個會員行使版主權限。注意：此設定僅對版主有效。管理員是預設擁有所有版面的全部管理權限的。',
...
'Confirmation info'				=>	'請確認您要刪除這個會員', // the username will be appended to this string
'Delete warning'				=>	'警告：刪除會員和/或文章的操作將無法恢復。如果您此時不刪除這個會員的文章，這些文章將只能通過手動刪除。',
'Delete posts'					=>	'刪除這個會員發表的所有主題和文章。',
...
'Ban redirect'					=>	'重新導向中 …',
'No delete admin message'		=>	'管理員群組中的成員不能刪除。如要刪除這個會員，您必須先將其轉移到另一個會員群組中。'
