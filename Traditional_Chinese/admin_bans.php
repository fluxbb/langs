...
'Ban search info'			=>	'在資料庫中搜尋被封鎖的使用者。您可輸入一項或多項以進行搜尋。可使用星號(*)作為萬用字元 。要顯示所有被封鎖的使用者時請留空。',
...
'IP label'					=>	'IP/IP-範圍',
'IP help'					=>	'您要封鎖的IP或IP範圍(例如：150.11.110.1或150.11.110)。IP位址間以空格分開。此處輸入的IP(如果存在)是從資料庫中取得這個使用者的最後IP。',
'IP help link'				=>	'點選%s查看這個使用者的IP統計。',
