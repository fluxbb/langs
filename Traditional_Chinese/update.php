...
$lang_update = array (
  ...
  'Current character set' => '<strong>當前字符集：</strong>如果在您的論壇的主要語言是英語，你可以保留此默認值。但是，如果您的論壇非英語的，你應該輸入的字符集使用的主要語言包了座談會。 <em>得到這個錯誤可能會損壞你的數據庫中，因此不只是猜測！</em>注：這是必需的，即使舊的數據庫是UTF - 8。 ',
