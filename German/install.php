...
'Info 1'						=>	'Bitte gib die abgefragten Daten ein, um die Datenbank für die Installation von FluxBB vorzubereiten. Du solltest all diese Daten kennen, BEVOR du mit der Installation weitermachst.',
'Select database'				=>	'Wähle hier deinen Datenbank-Typ',
'Info 2'						=>	'FluxBB unterstützt gegenwärtig MySQL, PostgreSQL und SQLite. Falls die Datenbank deiner Wahl nicht im nachfolgenden Listenfeld-Menü zu finden ist, bedeutet das, dass deine PHP-Umgebung diese Datenbank nicht unterstützt. Im FAQ findest du weitere Informationen zu den unterstützten Datenbank-Versionen.',
...
'Info 3'						=>	'Die Adresse des Datenbank-Servers (Beispiel: localhost, db.meinhost.de oder 192.168.0.15). Du kannst außerdem einen Port festlegen, falls deine Datenbank nicht den Standard-Port verwendet (Beispiel: localhost:3580). Für SQLite kannst du irgend etwas eingeben oder lass es einfach auf \'localhost\'.',
'Database server hostname'		=>	'Hostname des Datenbank-Servers',
'Database enter name'			=>	'Gib hier den Namen deiner Datenbank ein',
'Info 4'						=>	'Der Name der Datenbank, in die FluxBB installiert werden soll. Die Datenbank muss bereits existieren. Für SQLite muss hier der relative Pfad zur Datenbank-Datei angegeben werden. Falls die SQLite-Datenbank-Datei nicht existiert, wird FluxBB versuchen, diese zu erstellendoes not exist, FluxBB will attempt to create it.',
...
'Info 5'						=>	'Gib hier den Benutzernamen und das Passwort für die Verbindung zur Datenbank ein. Kann für SQLite ignoriert werden.',
'Database password'				=>	'Datenbank-Passwort',
'Database enter prefix'			=>	'Gib hier den Präfix für die Datenbank-Tabellen ein',
'Info 6'						=>	'Wenn du möchtest, kannst du hier einen Tabellen-Präfix festlegen. Auf diese Weise können mehrere FluxBB-Installationen die gleiche Datenbank verwenden (Beispiel: foo_).',
'Table prefix'					=>	'Tabellen-Präfix',
'Administration setup'			=>	'Administrations-Einstellung',
'Info 7'						=>	'Bitte gib die abgefragten Daten ein, um einen Administrator für deine FluxBB-Installation festzulegen.',
'Admin enter username'			=>	'Gib hier den Mitgliedsnamen des Administrators ein',
'Info 8'						=>	'Der Mitgliedsname des Administrator. Du kannst später weitere Administratoren und Moderatoren anlegen. Mitgliedsnamen können zwischen 2 und 25 Zeichen lang sein.',
'Admin enter password'			=>	'Gib hier das Passwort des Administrators ein und bestätige es anschließend noch einmal',
'Info 9'						=>	'Passwörter müssen mindestens 4 Zeichen lang sein. Außerdem sind die Passwörter zeichensensitiv (Groß-/Kleinschreibung).',
'Password'						=>	'Passwort',
'Confirm password'				=>	'Passwort bestätigen',
'Admin enter email'				=>	'Gib die E-Mail-Adresse des Administrators ein',
'Info 10'						=>	'Die E-Mail-Adresse des Foren-Administrators.',
'Board setup'					=>	'Board-Einstellung',
'Info 11'						=>	'Bitte gib die abgefragten Daten ein, um FluxBB zu installieren.',
'Enter board title'				=>	'Gib hier den Board-Titel ein',
'Info 12'						=>	'Der Titel dieses Forums (wird zu Beginn jeder Seite angezeigt).',
'Enter board description'		=>	'Gib hier die Beschreibung deines Boards ein',
'Info 13'						=>	'Eine kurze Beschreibung des Forums (wird zu Beginn jeder Seite angezeigt). Dieses Feld kann HTML enthalten.',
'Board description'				=>	'Board-Beschreibung',
'Enter base URL'				=>	'Gib hier die Basis-URL deiner FluxBB-Installation ein',
'Info 14'						=>	'Die URL deines FluxBB-Forums (ohne Trailing Slash) (Beispiel: http://forum.meinhost.de oder http://meinhost.de/~mitglied). Dies <strong>MUSS</strong> richtig sein, anderenfalls können Administratoren und Moderatoren keine Formulare absenden. Bitte beachte, dass es sich bei dem voreingestellten Wert lediglich um einen Erfahrungswert aus der FluxBB-Praxis handelt.',
'Choose the default language'	=>	'Wähle hier die voreingestellte Sprache',
'Info 15'						=>	'Die voreingestellte Sprache, die für Gäste und Mitglieder, die in ihrem Profil keine andere Wahl getroffen haben, verwendet wird.',
'Default language'				=>	'Voreingestellt Sprache',
'Choose the default style'		=>	'Wähle hier den voreingestellten Style',
'Info 16'						=>	'Der voreingestellt Style, der für Gäste und Mitglieder, die in ihrem Profil keine andere Wahl getroffen haben, verwendet wird.',
