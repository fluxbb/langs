...
'User title help'				=>	'Dieser Titel überschreibt den Benutzerrang, der dieser Gruppe zugeordnet ist. Ohne Vorgabe wird der voreingestellte Titel oder Rang verwendet.',
...
'Ban users label'				=>	'Erlaubt Moderatoren, Mitglieder zu bannen',
'Ban users help'				=>	'Wenn die Moderator-Privilegien aktiviert sind, können Mitglieder andere Mitglieder dieser Gruppe bannen.',
'Read board label'				=>	'Board lesen',
'Read board help'				=>	'Erlaubt den Mitgliedern dieser Gruppe, das Board anzusehen. Diese Einstellung hat auf alle Aspekte des Boards Auswirkungen und kann nicht durch Foren-spezifische Einstellungen überschrieben werden. Ist die Einstellung "Nein", können sich die Mitglieder dieser Gruppe nur an-/abmelden und registrieren.',
